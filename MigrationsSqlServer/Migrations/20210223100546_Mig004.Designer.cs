...
namespace MigrationsSqlServer.Migrations
{
    ...
    [Migration("20210223100546_Mig004")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheiaData.Data.Banner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheiaData.Data.CategoryBanner", b =>
                {
            ...
            modelBuilder.Entity("TheiaData.Data.ContentPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheiaData.Data.CategoryBanner", b =>
                {
                    b.HasOne("TheiaData.Data.Banner", "Banner")
                        .WithMany("CategoryBanners")
            ...
            modelBuilder.Entity("TheiaData.Data.Product", b =>
                {
                    b.HasOne("TheiaData.Data.Banner", null)
                        .WithMany("Products")
                        .HasForeignKey("BannerId");
