        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiplayName = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VariantGroups_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryBanners", x => new { x.CategoryId, x.BannerId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryVariantGroups", x => new { x.CategoryId, x.VariantGroupId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VariantGroups_UserId",
                table: "VariantGroups",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Variants_Name_VariantGroupId",
                table: "Variants",
                columns: new[] { "Name", "VariantGroupId" },
                unique: true);
